...
if __name__ == '__main__':
    ...
    train.to_feather('../features/train/Agg_Itemseq_median_Silver_train.feather')
    test.to_feather('../features/test/Agg_Itemseq_median_Silver_test.feather')
    train_active.to_feather('../features/train_active/Agg_Itemseq_median_Silver_train_active.feather')
    test_active.to_feather('../features/test_active/Agg_Itemseq_median_Silver_test_active.feather')
