...
if __name__ == '__main__':
    print('start')
    train = pd.read_csv('../input/train.csv', usecols=textfeats, nrows=100000)
    test = pd.read_csv('../input/test.csv', usecols=textfeats, nrows=100000)
    train_active = pd.read_csv('../input/train_active.csv', usecols=textfeats, nrows=100000)
    test_active = pd.read_csv('../input/test_active.csv', usecols=textfeats, nrows=100000)
